...
public class MainTvFragment extends BrowseFragment implements LoaderManager.LoaderCallbacks<HashMap<String, List<Movie>>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.row_header,null);
        return v;
    }
    ...
    /*private void loadVideoData() {
        Connection.VideoProvider.setContext(getActivity());
